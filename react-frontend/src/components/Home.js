    ...
    <>
      ...
      <div className={`${classes.content}`}>
        <p>
          ...
          >
            <i class="bi bi-facebook"></i> CrimeBook
          </a>{" "}
          or to{" "}
          <a
            ...
            className={`${classes.aTag}`}
          >
            <i class="bi bi-instagram"></i> CrimeBook
          </a>{" "}
      ...
      <footer className={`${classes.Homefooter}`}>
        ...
        <a href="mailto:stopcrime472@gmail.com"><i class="bi bi-envelope-at-fill"></i></a>
        <a href="#"><i class="bi bi-telephone-fill"></i></a>
        <a href="https://www.facebook.com/profile.php?id=100091779218215&mibextid=ZbWKwL"><i class="bi bi-facebook"></i></a>
        <a href="https://instagram.com/crimestopper2?igshid=ZDdkNTZiNTM="><i class="bi bi-instagram"></i></a>
        </div>
